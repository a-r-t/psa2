...
namespace PSA2MovesetLogic.src.FileProcessor.MovesetHandler.MovesetHandlerHelpers
{
    public class SubActionsHandler
    {
        ...
        public SubActionsHandler(PsaFile psaFile, int dataSectionLocation, CodeBlockHandler codeBlocksHandler, PsaCommandHandler psaCommandHandler, AnimationsHandler animationsHandler, int codeBlockDataStartLocation)
        {
            PsaFile = psaFile;
