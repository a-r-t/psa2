...
namespace PSA2Tests.Tests.ActionsTests
{
    ...
    public class ModifyCommandInActionTests
    {
        ...
        public void ModifyCommandInActionWithIdenticalCommand()
        {
            ...
            psaMovesetParser.ActionsHandler.ModifyActionCommand(0, 0, 0, new PsaCommand(33620480, 25788, parameters));
        ...
        public void ModifyCommandInActionWithDifferentCommandWithIdenticalParameterCount()
        {
            ...
            psaMovesetParser.ActionsHandler.ModifyActionCommand(0, 0, 0, new PsaCommand(67109376, 25788, parameters));
        ...
        public void ModifyCommandInActionWithDifferentCommandWithLargerParameterCount()
        {
            ...
            psaMovesetParser.ActionsHandler.ModifyActionCommand(0, 0, 0, new PsaCommand(33620736, 25788, parameters));
        ...
        public void ModifyCommandInActionWithNoParametersToCommandWithParameters()
        {
            ...
            psaMovesetParser.ActionsHandler.ModifyActionCommand(0, 0, 10, new PsaCommand(33620480, 25788, parameters));
